pipeline {
  agent any
  environment {
    PIPELINE_USER_CREDENTIAL_ID = 'aws-access-ruwanvm'
    SAM_TEMPLATE = 'sam-pipeline-check/template.yaml'
    MAIN_BRANCH = 'master'
    TESTING_STACK_NAME = 'sam-app-dev'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::096281385844:role/aws-sam-cli-managed-dev-pipel-PipelineExecutionRole-9sF0ud2vSoy8'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::096281385844:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionRo-ChDNqvkFTMS9'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-r-artifactsbucket-xogqapqbxbqt'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::096281385844:role/aws-sam-cli-managed-prod-pipe-PipelineExecutionRole-a4VAjRLMnRxx'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::096281385844:role/aws-sam-cli-managed-prod--CloudFormationExecutionRo-v0OAThREQ7mI'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline--artifactsbucket-yuuhligecue4'
    // If there are functions with "Image" PackageType in your template,
